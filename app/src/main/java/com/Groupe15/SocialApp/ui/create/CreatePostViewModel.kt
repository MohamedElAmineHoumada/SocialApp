...
class AudiencePickerBottomSheet : BottomSheetDialogFragment() {
    ...
    // Callback vers le fragment parent
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.optionPublic.setOnClickListener {
            ...
            // Mettre à jour le chip dans le fragment parent
            (parentFragment as? CreatePostFragment)
                ?.let { /* le fragment gère via ViewModel si besoin */ }
            dismiss()
        }
